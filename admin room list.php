<div>
        <table  >
            ...
            ?>
                        ...
                        <tr>
                            <td><?php echo $sn++; ?></td>
                            <td class="td-rw-ad"><?php echo $time; ?></td>
                            <td class="td-rw-ad"><?php echo $roomid; ?></td>
                            <td><button type="button" class="button-46" onclick="window.open('<?php echo SITEURL; echo $roomid;?>','_blank')">进入</button>
                            </td>
                            <td><button type="button" class="button-47" onclick="window.location.href='deleteroom.php?id=<?php echo $id;?>'" >删除</button></td>
